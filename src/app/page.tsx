          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div className="reveal-on-scroll">
              ...
              <div className="space-y-8 md:space-y-12">
                <div className="p-8 md:p-10 bg-accent text-white rounded-[3rem] shadow-2xl relative overflow-hidden group hover:scale-[1.02] transition-all">
                  ...
                  <div className="relative z-10 flex flex-col gap-6">
                    ...
                    <Link href="https://www.instagram.com/fable.and.forever/" target="_blank" className="inline-flex items-center justify-center gap-4 text-[10px] font-black uppercase tracking-[0.6em] bg-white text-accent px-8 py-5 rounded-full mt-4 w-full md:w-fit shadow-lg">
            ...
            <form onSubmit={handleContactSubmit} className="space-y-10 md:space-y-12 reveal-on-scroll stagger-2 bg-white p-8 md:p-20 rounded-[3rem] md:rounded-[5rem] border border-primary/10 shadow-[0_60px_120px_-30px_rgba(0,0,0,0.15)] relative overflow-hidden">
               <div className="absolute top-0 left-0 w-full h-2 bg-accent/20"></div>
               <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
                  <div className="space-y-4 border-b-2 border-primary/80 pb-6 focus-within:border-accent transition-colors">
                    <label className="text-[11px] font-black uppercase tracking-[0.5em] text-primary">Your Name</label>
                    <Input 
                      required
                      placeholder="Your name" 
                      className="border-none bg-transparent p-0 text-xl md:text-3xl placeholder:text-primary/20 rounded-none focus-visible:ring-0 font-headline h-auto text-primary font-bold" 
                    />
                  </div>
                  <div className="space-y-4 border-b-2 border-primary/80 pb-6 focus-within:border-accent transition-colors">
               ...
               <div className="space-y-4 border-b-2 border-primary/80 pb-6 focus-within:border-accent transition-colors">
                  ...
                  <Textarea 
                    ...
                    className="border-none bg-transparent p-0 min-h-[140px] md:min-h-[160px] text-xl md:text-3xl placeholder:text-primary/20 rounded-none focus-visible:ring-0 resize-none font-headline text-primary leading-relaxed font-bold" 
                  />
               </div>
               <Button type="submit" className="bg-primary hover:bg-primary/90 text-white h-20 md:h-24 px-16 rounded-full text-[12px] font-black uppercase tracking-[0.8em] w-full transition-all active:scale-95 shadow-2xl shadow-primary/40 hover:scale-[1.02] group">
