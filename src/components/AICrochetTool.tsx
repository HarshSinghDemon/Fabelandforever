...
import { Sparkles, Loader2, Wand2, BookOpen, Star } from 'lucide-react';
...
export function AICrochetTool() {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-xl p-10 rounded-[3rem] border-[3px] border-primary/10 shadow-2xl relative overflow-hidden stitching-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="bg-white border-2 border-primary/10 focus:border-accent rounded-2xl h-14 px-6 text-lg"
            ...
            <div className="space-y-2">
              ...
              <Input 
                id="color"
                placeholder="e.g., Deep Teal & Gold"
                className="bg-white border-2 border-primary/10 focus:border-accent rounded-2xl h-14 px-6 text-lg"
          ...
          <div className="space-y-5 animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <div className="grid gap-4">
              {ideas.map((idea, idx) => (
                <div 
                  key={idx} 
                  className="p-6 bg-primary/5 rounded-3xl border border-primary/10 text-primary font-medium leading-relaxed shadow-sm hover:shadow-md transition-all flex items-start gap-4"
                >
