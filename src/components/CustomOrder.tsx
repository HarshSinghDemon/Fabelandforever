          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-lg italic font-medium">
                "Every custom piece begins with a story. Upload your inspiration and let's weave a legacy together."
              </p>
              
              <div className="space-y-8 mb-12">
                {[
                  { step: '01', title: 'Fiber Selection', desc: 'Choose from our curated ethically-sourced wools and cottons.' },
                  { step: '02', title: 'Pattern Design', desc: 'We translate your sketches or photos into a unique crochet chart.' },
                  { step: '03', title: 'The Weaver\'s Hand', desc: 'Each stitch is executed with precision and a lifetime of care.' }
                ].map((item) => (
              ...
              <div className="bg-accent/5 p-8 rounded-[2rem] stitching-border max-w-md">
                ...
                <div className="relative">
                  <input 
                    ...
                    accept="image/*"
                  />
                  <div className="bg-white border-2 border-dashed border-accent/40 rounded-xl p-6 text-center group hover:border-accent transition-colors">
                    {uploading ? (
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-primary uppercase tracking-widest">Drop a photo here</span>
                      </div>
                    )}
                  </div>
                </div>
