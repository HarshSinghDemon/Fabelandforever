      ...
      <div className="container mx-auto px-6 pt-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-2">
            <h2 className="font-fancy text-5xl mb-8">Cloudy Tale 📖</h2>
            <p className="text-primary-foreground/70 max-w-sm mb-10 leading-relaxed font-medium text-lg italic">
              "Weaving magical stories into every loop, creating handmade companions for your journey."
            </p>
          ...
          <div>
            <h4 className="font-bold uppercase tracking-[0.3em] text-[10px] mb-10 text-accent">Chapter Index</h4>
            <ul className="space-y-5 text-sm font-bold uppercase tracking-widest">
              <li><Link href="#shop" className="text-primary-foreground/60 hover:text-accent transition-colors">Enchanted Shop</Link></li>
              <li><Link href="#custom" className="text-primary-foreground/60 hover:text-accent transition-colors">Custom Tales</Link></li>
              <li><Link href="#story" className="text-primary-foreground/60 hover:text-accent transition-colors">The Weaver</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm font-medium text-primary-foreground/70">
              ...
              <li className="flex gap-4">
                ...
                <span>By the moonlight & midday tea (10am - 5pm)</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 text-[10px] font-bold text-primary-foreground/40 uppercase tracking-[0.4em]">
          <p className="flex items-center gap-3">Crafted with <Sparkles className="text-accent fill-accent w-4 h-4" /> & Golden Thread</p>
          <div className="flex gap-10">
            <Link href="#" className="hover:text-accent transition-colors">Privacy Scrolls ✨</Link>
            <Link href="#" className="hover:text-accent transition-colors">Terms of Magic 📜</Link>
          </div>
        </div>
      </div>
    </footer>
