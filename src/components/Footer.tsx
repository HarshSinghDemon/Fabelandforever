...
export function Footer() {
  return (
    <footer id="footer" className="bg-[#050505] text-white py-12 md:py-20 relative overflow-hidden border-t border-white/10">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 mb-12">
          ...
          <div className="lg:col-span-5 space-y-8 reveal-on-scroll">
            ...
            <p className="text-white/60 max-w-sm leading-relaxed font-medium text-xs md:text-sm italic">
            ...
            <div className="pt-2">
               <Link 
                ...
                target="_blank" 
                className="inline-flex items-center gap-4 bg-white/5 backdrop-blur-xl border border-white/10 px-6 py-4 rounded-[2rem] hover:bg-white/10 transition-all group shadow-2xl w-full md:w-auto justify-center md:justify-start"
               >
                  <div className="bg-gradient-to-tr from-accent to-accent/50 p-2.5 rounded-full shadow-lg group-hover:rotate-12 transition-transform">
          ...
          <div className="lg:col-span-3 space-y-6 reveal-on-scroll stagger-1">
            ...
            <ul className="space-y-4 text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em]">
              <li><Link href="/shop" className="text-white/60 hover:text-white transition-colors">Shop Catalog</Link></li>
              <li><Link href="/about" className="text-white/60 hover:text-white transition-colors">The Weaver's Story</Link></li>
              <li><Link href="/#contact" className="text-white/60 hover:text-white transition-colors">Manifest Vision</Link></li>
              <li><Link href="mailto:fableandforevercompany@gmail.com" className="text-white/60 hover:text-white transition-colors">Send Email</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 text-[8px] md:text-[9px] font-bold text-white/30 uppercase tracking-[0.4em] md:tracking-[0.6em] text-center md:text-left">
